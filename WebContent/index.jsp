...
<html>
<head>
<link rel="stylesheet" type="text/css" href="/CurrencyConverter/css/styles.css">  
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
<script src="js/validateConversionPage.js" type="text/javascript"></script>
...
<h1>CurrencyConverter</h1>
 ...
 <form action="/CurrencyConverter/ProjectServlet" method="post">
 <input type="submit" name="action" value="Refresh" id="refresh" size="20">
 <input  type="text" id="amount1" name="amount1" value="" size="20"/>   
...
<br><br>
<center>
<input type="submit" name="action" value="convert" id="submit" disabled="disabled" size="20"/>
<br><br>
</center>   
   <center>
   <b style="color:white;">Result:</b>
   <input type="text" id="convertValue" size="20" value="<%
   if(request.getAttribute("conversionResult")!=null)
   {
  	String resultValue=String.valueOf(request.getAttribute("conversionResult"));
   	out.print(""+resultValue);
   }
   %>"> 
   </center>
   <a href="/CurrencyConverter/history.jsp" style="color:white">History</a>
  </form> 
</body>
</html>