...
<head>
     ...
     <script src="js/validateHistory.js" type="text/javascript"></script>
     <meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
     <title>History Page</title>   
</head>
<body>
<form action="/CurrencyConverter/HistoryServlet" method="post" id="form">
      <center>
   ...
   <option value='ZWL' title='Zimbabwean Dollar'>ZWL</option>
      ...
      <br><br>
      From Date:<input type="date" size="20" name="fromdate" id="fromdate"/>
      To Date:<input type="date" size="20" name="todate" id="todate"/>
      <br><br>
